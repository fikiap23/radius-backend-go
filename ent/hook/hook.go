...
// The BoardColumnFunc type is an adapter to allow the use of ordinary
// function as BoardColumn mutator.
type BoardColumnFunc func(context.Context, *ent.BoardColumnMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f BoardColumnFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.BoardColumnMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.BoardColumnMutation", m)
}
...
// The UserOAuthAccountFunc type is an adapter to allow the use of ordinary
// function as UserOAuthAccount mutator.
type UserOAuthAccountFunc func(context.Context, *ent.UserOAuthAccountMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UserOAuthAccountFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserOAuthAccountMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UserOAuthAccountMutation", m)
}
