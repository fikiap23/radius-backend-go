...
type TaskQuery struct {
	...
	withColumn         *BoardColumnQuery
	withAssignee       *UserQuery
	withSubtasks       *TaskSubtaskQuery
	withChecklistItems *TaskChecklistItemQuery
	withAttachments    *TaskAttachmentQuery
	withComments       *TaskCommentQuery
	withActivityLogs   *TaskActivityLogQuery
...
func (tq *TaskQuery) QueryWorkspace() *WorkspaceQuery {
	query := (&WorkspaceClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (tq *TaskQuery) QueryColumn() *BoardColumnQuery {
	query := (&BoardColumnClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (tq *TaskQuery) QuerySubtasks() *TaskSubtaskQuery {
	query := (&TaskSubtaskClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryChecklistItems chains the current query on the "checklist_items" edge.
func (tq *TaskQuery) QueryChecklistItems() *TaskChecklistItemQuery {
	query := (&TaskChecklistItemClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (tq *TaskQuery) QueryAttachments() *TaskAttachmentQuery {
	query := (&TaskAttachmentClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (tq *TaskQuery) QueryComments() *TaskCommentQuery {
	query := (&TaskCommentClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (tq *TaskQuery) QueryActivityLogs() *TaskActivityLogQuery {
	query := (&TaskActivityLogClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (tq *TaskQuery) Clone() *TaskQuery {
	...
	return &TaskQuery{
		...
		withChecklistItems: tq.withChecklistItems.Clone(),
		withAttachments:    tq.withAttachments.Clone(),
		withComments:       tq.withComments.Clone(),
		withActivityLogs:   tq.withActivityLogs.Clone(),
...
func (tq *TaskQuery) WithWorkspace(opts ...func(*WorkspaceQuery)) *TaskQuery {
	query := (&WorkspaceClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (tq *TaskQuery) WithColumn(opts ...func(*BoardColumnQuery)) *TaskQuery {
	query := (&BoardColumnClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (tq *TaskQuery) WithSubtasks(opts ...func(*TaskSubtaskQuery)) *TaskQuery {
	query := (&TaskSubtaskClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithChecklistItems tells the query-builder to eager-load the nodes that are connected to
// the "checklist_items" edge. The optional arguments are used to configure the query builder of the edge.
func (tq *TaskQuery) WithChecklistItems(opts ...func(*TaskChecklistItemQuery)) *TaskQuery {
	query := (&TaskChecklistItemClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withChecklistItems = query
	return tq
}
...
func (tq *TaskQuery) WithAttachments(opts ...func(*TaskAttachmentQuery)) *TaskQuery {
	query := (&TaskAttachmentClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (tq *TaskQuery) WithComments(opts ...func(*TaskCommentQuery)) *TaskQuery {
	query := (&TaskCommentClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (tq *TaskQuery) WithActivityLogs(opts ...func(*TaskActivityLogQuery)) *TaskQuery {
	query := (&TaskActivityLogClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withActivityLogs = query
	return tq
}
...
func (tq *TaskQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Task, error) {
	var (
		...
		loadedTypes = [9]bool{
			...
			tq.withAssignee != nil,
			tq.withSubtasks != nil,
			tq.withChecklistItems != nil,
			tq.withAttachments != nil,
			tq.withComments != nil,
			tq.withActivityLogs != nil,
		}
	)
	...
	if query := tq.withWorkspace; query != nil {
		if err := tq.loadWorkspace(ctx, query, nodes, nil,
	...
	if query := tq.withColumn; query != nil {
		if err := tq.loadColumn(ctx, query, nodes, nil,
			func(n *Task, e *BoardColumn) { n.Edges.Column = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := tq.withSubtasks; query != nil {
		if err := tq.loadSubtasks(ctx, query, nodes,
			func(n *Task) { n.Edges.Subtasks = []*TaskSubtask{} },
			func(n *Task, e *TaskSubtask) { n.Edges.Subtasks = append(n.Edges.Subtasks, e) }); err != nil {
			return nil, err
		}
	}
	if query := tq.withChecklistItems; query != nil {
		if err := tq.loadChecklistItems(ctx, query, nodes,
			func(n *Task) { n.Edges.ChecklistItems = []*TaskChecklistItem{} },
			func(n *Task, e *TaskChecklistItem) { n.Edges.ChecklistItems = append(n.Edges.ChecklistItems, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := tq.withActivityLogs; query != nil {
		if err := tq.loadActivityLogs(ctx, query, nodes,
			func(n *Task) { n.Edges.ActivityLogs = []*TaskActivityLog{} },
			func(n *Task, e *TaskActivityLog) { n.Edges.ActivityLogs = append(n.Edges.ActivityLogs, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (tq *TaskQuery) loadWorkspace(ctx context.Context, query *WorkspaceQuery, nodes []*Task, init func(*Task), assign func(*Task, *Workspace)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Task)
	for i := range nodes {
...
func (tq *TaskQuery) loadColumn(ctx context.Context, query *BoardColumnQuery, nodes []*Task, init func(*Task), assign func(*Task, *BoardColumn)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Task)
	for i := range nodes {
		if nodes[i].ColumnID == nil {
			continue
		}
		fk := *nodes[i].ColumnID
		if _, ok := nodeids[fk]; !ok {
	...
	query.Where(boardcolumn.IDIn(ids...))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	}
	for _, n := range neighbors {
		nodes, ok := nodeids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "column_id" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (tq *TaskQuery) loadSubtasks(ctx context.Context, query *TaskSubtaskQuery, nodes []*Task, init func(*Task), assign func(*Task, *TaskSubtask)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(tasksubtask.FieldTaskID)
	}
	query.Where(predicate.TaskSubtask(func(s *sql.Selector) {
...
func (tq *TaskQuery) loadChecklistItems(ctx context.Context, query *TaskChecklistItemQuery, nodes []*Task, init func(*Task), assign func(*Task, *TaskChecklistItem)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Task)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(taskchecklistitem.FieldTaskID)
	}
	query.Where(predicate.TaskChecklistItem(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(task.ChecklistItemsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (tq *TaskQuery) loadAttachments(ctx context.Context, query *TaskAttachmentQuery, nodes []*Task, init func(*Task), assign func(*Task, *TaskAttachment)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Task)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (tq *TaskQuery) loadComments(ctx context.Context, query *TaskCommentQuery, nodes []*Task, init func(*Task), assign func(*Task, *TaskComment)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Task)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (tq *TaskQuery) loadActivityLogs(ctx context.Context, query *TaskActivityLogQuery, nodes []*Task, init func(*Task), assign func(*Task, *TaskActivityLog)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Task)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(taskactivitylog.FieldTaskID)
	}
	query.Where(predicate.TaskActivityLog(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(task.ActivityLogsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (tq *TaskQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := tq.ctx.Fields; len(fields) > 0 {
		...
		if tq.withWorkspace != nil {
			_spec.Node.AddColumnOnce(task.FieldWorkspaceID)
		}
		if tq.withColumn != nil {
			_spec.Node.AddColumnOnce(task.FieldColumnID)
		}
